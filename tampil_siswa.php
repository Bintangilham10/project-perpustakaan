    ...
    <table class="table table-hover table-striped">
        ...
        <?php
            ...
            <tr>
                ...
                <td><a href="ubah_siswa.php?id_siswa=<?=$idsis?>"class="btn btn-success">Ubah</a> | 
                <a href="hapus.php?id_siswa=<?=$idsis?>" onclick="return confirm('Apakah anda yakin menghapus dataini?')" 
